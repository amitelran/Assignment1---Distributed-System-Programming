...
public class inputFile {
	...
	private String file_unique_key;
	private String file_QueueURL;
	private int num_of_tasks;
	private int num_of_completed_tasks;
	
	public inputFile(String fileBucket, String fileKey, String fileUniqueKey, String queueURL, int numTasks){
		this.file_Bucket = fileBucket;
		this.file_Key = fileKey;
		this.file_unique_key = fileUniqueKey;
